...
if __name__ == '__main__':
    ...
    csv_path = r"D:\Aamir Gulzar\KSA_project2\Cancer-detection-classifier\data_preprocessing\FLAT_DIRECTORY\process_list_final.csv"
    ...
    try:
        ...
        row_data = {'slide_id': sample_files[0], 'process':0, 'status': 'processed'}
        for param_group in parameters.values():
            row_data.update(param_group)
